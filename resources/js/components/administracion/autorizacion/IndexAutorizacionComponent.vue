          ...
          >
            ...
            <tbody>
              <tr v-for="(e, i) in usuarios" v-bind:key="i">
                ...
                <td>
                  {{ moment
                    .utc(e.created_at, "YYYY-MM-DD HH:mm:ss")
                    .local()
...
export default {
  data() {
    return {
      estado_selected: 0,
      estados: [{ id: 0, value: "Por Revisar" }, { id: 2, value: "No autorizados" }],
      usuarios: "",
      usuario: "",
    };
  },
  ...
  methods: {
    async getUsuarios() {
      ...
      let usuarios = User.include("empresa", "empresaSede").where("estado", this.estado_selected ? this.estado_selected : 0);
