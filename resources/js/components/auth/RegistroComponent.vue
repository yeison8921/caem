                        ...
                        <v-stepper-content step="1">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input
                                        v-model.trim="
                                            $v.confirmar_correo.$model
                                        "
                                        type="email"
                                        class="form-control"
                                        :class="{
                                            'is-invalid':
                                                $v.confirmar_correo.$error,
                                            'is-valid':
                                                correo != ''
                                                    ? !$v.confirmar_correo
                                                          .$invalid
                        ...
                        <v-stepper-content step="2">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input
                                        ...
                                        :class="{
                                            'is-invalid':
                                                $v.form.confirmar_correo.$error,
                                            'is-valid':
                                                form.correo != ''
                                                    ? !$v.form.confirmar_correo
                                                          .$invalid
                                                    : '',
                                        }"
                                    />
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input
                                        ...
                                        :class="{
                                            'is-invalid':
                                                $v.form.contrasena.$error,
                                            'is-valid':
                                                !$v.form.contrasena.$invalid,
                                        }"
                                    />
                                    <div class="invalid-feedback">
                                        <span
                                            v-if="!$v.form.contrasena.required"
                                            >{{ required }}</span
                                        >
                                        <span
                                            v-if="!$v.form.contrasena.minLength"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input
                                        v-model.trim="
                                            $v.form.confirmar_contrasena.$model
                                        "
                                        type="password"
    ...
    methods: {
        submit() {
            ...
            if (this.paso == 1) {
                if (
                    !(
                        this.$v.correo.$invalid ||
                        this.$v.confirmar_correo.$invalid
                    )
                ) {
                    this.paso = 2;
                    this.$v.$reset();
